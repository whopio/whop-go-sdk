...
// ConfirmProductRequest struct for ConfirmProductRequest
...
// NewConfirmProductRequest instantiates a new ConfirmProductRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewConfirmProductRequest() *ConfirmProductRequest {
	this := ConfirmProductRequest{}
	return &this
}

// NewConfirmProductRequestWithDefaults instantiates a new ConfirmProductRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewConfirmProductRequestWithDefaults() *ConfirmProductRequest {
	this := ConfirmProductRequest{}
	return &this
}

// GetCancelAction returns the CancelAction field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetCancelAction() string {
...
func (o *ConfirmProductRequest) GetCancelActionOk() (*string, bool) {
	if o == nil || o.CancelAction == nil {
		return nil, false
	}
...
func (o *ConfirmProductRequest) HasCancelAction() bool {
	if o != nil && o.CancelAction != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetCancelAction(v string) {
	o.CancelAction = &v
}

// GetTitle returns the Title field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetTitle() string {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetTitleOk() (*string, bool) {
	if o == nil || o.Title == nil {
		return nil, false
	}
	return o.Title, true
...
func (o *ConfirmProductRequest) HasTitle() bool {
	if o != nil && o.Title != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetTitle(v string) {
	o.Title = &v
}

// GetExpirationDays returns the ExpirationDays field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetExpirationDays() int64 {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetExpirationDaysOk() (*int64, bool) {
	if o == nil || o.ExpirationDays == nil {
		return nil, false
	}
...
func (o *ConfirmProductRequest) HasExpirationDays() bool {
	if o != nil && o.ExpirationDays != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetExpirationDays(v int64) {
	o.ExpirationDays = &v
}

// GetCurrency returns the Currency field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetCurrency() string {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetCurrencyOk() (*string, bool) {
	if o == nil || o.Currency == nil {
		return nil, false
	}
...
func (o *ConfirmProductRequest) HasCurrency() bool {
	if o != nil && o.Currency != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetCurrency(v string) {
	o.Currency = &v
}

// GetLicenseType returns the LicenseType field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetLicenseType() string {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetLicenseTypeOk() (*string, bool) {
	if o == nil || o.LicenseType == nil {
		return nil, false
	}
...
func (o *ConfirmProductRequest) HasLicenseType() bool {
	if o != nil && o.LicenseType != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetLicenseType(v string) {
	o.LicenseType = &v
}

// GetInitialPrice returns the InitialPrice field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetInitialPrice() float32 {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetInitialPriceOk() (*float32, bool) {
	if o == nil || o.InitialPrice == nil {
		return nil, false
	}
...
func (o *ConfirmProductRequest) HasInitialPrice() bool {
	if o != nil && o.InitialPrice != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetInitialPrice(v float32) {
	o.InitialPrice = &v
}

// GetPrice returns the Price field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetPrice() float32 {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetPriceOk() (*float32, bool) {
	if o == nil || o.Price == nil {
		return nil, false
	}
	return o.Price, true
...
func (o *ConfirmProductRequest) HasPrice() bool {
	if o != nil && o.Price != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetPrice(v float32) {
	o.Price = &v
}

// GetBillingPeriod returns the BillingPeriod field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetBillingPeriod() int64 {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetBillingPeriodOk() (*int64, bool) {
	if o == nil || o.BillingPeriod == nil {
		return nil, false
	}
...
func (o *ConfirmProductRequest) HasBillingPeriod() bool {
	if o != nil && o.BillingPeriod != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetBillingPeriod(v int64) {
	o.BillingPeriod = &v
}

// GetStock returns the Stock field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetStock() int64 {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetStockOk() (*int64, bool) {
	if o == nil || o.Stock == nil {
		return nil, false
	}
	return o.Stock, true
...
func (o *ConfirmProductRequest) HasStock() bool {
	if o != nil && o.Stock != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetStock(v int64) {
	o.Stock = &v
}

// GetTransferable returns the Transferable field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetTransferable() bool {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetTransferableOk() (*bool, bool) {
	if o == nil || o.Transferable == nil {
		return nil, false
	}
...
func (o *ConfirmProductRequest) HasTransferable() bool {
	if o != nil && o.Transferable != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetTransferable(v bool) {
	o.Transferable = &v
}

// GetCustomTrialPeriod returns the CustomTrialPeriod field value if set, zero value otherwise.
func (o *ConfirmProductRequest) GetCustomTrialPeriod() int64 {
...
// and a boolean to check if the value has been set.
func (o *ConfirmProductRequest) GetCustomTrialPeriodOk() (*int64, bool) {
	if o == nil || o.CustomTrialPeriod == nil {
		return nil, false
	}
...
func (o *ConfirmProductRequest) HasCustomTrialPeriod() bool {
	if o != nil && o.CustomTrialPeriod != nil {
		return true
	}
...
func (o *ConfirmProductRequest) SetCustomTrialPeriod(v int64) {
	o.CustomTrialPeriod = &v
}

func (o ConfirmProductRequest) MarshalJSON() ([]byte, error) {
...
type NullableConfirmProductRequest struct {
	value *ConfirmProductRequest
	isSet bool
}

func (v NullableConfirmProductRequest) Get() *ConfirmProductRequest {
	return v.value
}

func (v *NullableConfirmProductRequest) Set(val *ConfirmProductRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableConfirmProductRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableConfirmProductRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfirmProductRequest(val *ConfirmProductRequest) *NullableConfirmProductRequest {
	return &NullableConfirmProductRequest{value: val, isSet: true}
}

func (v NullableConfirmProductRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfirmProductRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
