...
func (o *UpdateLicenseByKeyResponse) GetMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UpdateLicenseByKeyResponse) GetMetadataOk() (*map[string]interface{}, bool) {
	if o == nil || o.Metadata == nil {
		return nil, false
	}
...
func (o *UpdateLicenseByKeyResponse) SetMetadata(v map[string]interface{}) {
	o.Metadata = &v
}
