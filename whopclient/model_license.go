...
func (o *License) GetMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *License) GetMetadataOk() (*map[string]interface{}, bool) {
	if o == nil || o.Metadata == nil {
		return nil, false
	}
...
func (o *License) SetMetadata(v map[string]interface{}) {
	o.Metadata = &v
}
